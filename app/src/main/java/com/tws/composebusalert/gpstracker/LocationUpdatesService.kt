package com.tws.composebusalert.gpstracker
...
//            startForeground(NOTIFICATION_ID, getNotification());
    ...
    private val notification: Notification
        private get() {
            ...
            val text: CharSequence = LocationUtils.getLocationText(mLocation)
            ...
            val builder =
                NotificationCompat.Builder(this)
                    .addAction(
                        R.drawable.bus_medium, getString(R.string.launch_activity),
                        activityPendingIntent
                    )
                    .addAction(
                        R.drawable.bus_medium, getString(R.string.remove_location_updates),
    ...
    companion object {
        private const val PACKAGE_NAME = "com.example.buzz.gpstracker.LocationUpdatesService"
